...
export default function Form(){
    ...
    return (
        <div className="w-[432px] mr-auto ml-auto text-center flex flex-col border rounded-lg shadow-lg bg-white mb-[60px]">
            ...
            <hr />
            <form className="w-[397px] mr-auto ml-auto">
                <div className="mt-4">
                    <input type="text" placeholder="Imię" className="w-[192px] h-[38px] border rounded-md mr-[11px] p-2"/>
                    <input type="text" placeholder="Nazwisko" className="w-[192px] h-[38px] border rounded-md p-2"/>
                </div>
                <DateOfBirth />
                <div>
                    ...
                    <div id="hidden_gender" className="hidden">
                        <div>
                            <select defaultValue={0} className="w-[397px] h-[34px] mr-3 border rounded-md mt-[14px] p-2">
                                ...
                                <option className="p-2"> Ona: Złóż jej życzenia urodzinowe!</option>
                                <option className="p-2"> On: Złóż mu życzenia urodzinowe!</option>
                                <option className="p-2"> Oni/one: Złóż mu/jej życzenia urodzinowe!</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <input className="w-[397px] h-[34px] mr-3 border rounded-md p-2" type="text"
                                   placeholder="Płeć (opcjonalnie)"/>
                        </div>
                    </div>
                </div>
                <div>
                    <input type="text" placeholder="Numer telefonu komórkowego lub e-mail"
                           className="w-full h-[38px] border rounded-md mt-2 p-2"/>
                    <input type="password" placeholder="Nowe hasło" className="w-full h-[38px] border rounded-md mt-2.5 mb-6 p-2"/>
                </div>
